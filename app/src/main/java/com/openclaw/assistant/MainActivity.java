...
public class MainActivity extends Activity {
    ...
    private void checkDeviceCompatibility() {
        ...
        // Z Fold 7 is cutting edge (Snapdragon 8 Elite) - AICore is definitely supported
    ...
    private boolean isMateDefaultAssistant() {
        ...
        return assistant != null && assistant.contains("com.openclaw.assistant");
    }
    ...
    private View createSettingsView() {
        ...
        aboutContent.setText("Mate is a local-first, privacy-focused AI assistant built with Gemini Nano. No data leaves your Pixel 8+ device.");
